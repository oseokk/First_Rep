...
List<CinemaDto> dto = (List<CinemaDto>)request.getAttribute("lists");
...
<div class="container">
		<div class="row">
<form action="./playhall_add.do" method="post">
	<table class="table table-striped"
					style="text-align: center; border: 1px solid #dddddd">
					<thead>
						<tr>
							<th colspan="3"
								style="background-color: #eeeeee; text-align: center;">상영관등록</th>
						</tr>
					</thead>
					<tbody>
	<tr>
	
				<td><input type="text" class=" form-control" id="cin_cd" name="cin_cd" value="${cin_cd }"  readonly="readonly"></td>
		</tr>
		<tr>
			<td>
				<input type="text" class=" form-control" placeholder="상영관이름 ex)1관" id="playhall_name" name="playhall_name" maxlength="3" required="required">
			</td>
		</tr>
